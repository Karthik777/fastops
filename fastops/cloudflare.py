...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_cloudflare.ipynb.

# %% auto #0
__all__ = ['CF', 'dns_record', 'tunnel_record']

# %% ../nbs/01_cloudflare.ipynb #a6e48b4c
import os
from cloudflare import Cloudflare
from fastcore.all import L, first, patch
from .core import secret_get

# %% ../nbs/01_cloudflare.ipynb #297e5764
class CF:
