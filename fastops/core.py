...
# %% auto #0
__all__ = ['dk', 'Dockerfile', 'Cli', 'calldocker', 'Docker', 'test', 'run', 'containers', 'images', 'stop', 'logs', 'rm', 'rmi']

# %% ../nbs/00_core.ipynb #c7b52454175ab4d4
import re, json, subprocess
from pathlib import Path
from fastcore.all import listify, joins, is_listy, L, patch, concat, bind
...
def _copy(src:str, dst:str, from_:str=None, link=False):
    ...
    flags = _build_flags(short=False, link=link, from_=from_)
    return _instr('COPY', ' '.join([*flags, src, dst]))
...
class Dockerfile(L):
    ...
    def __call__(self, kw, *args, **kwargs):
        ...
        flags = _build_flags(short=False, **kwargs)
